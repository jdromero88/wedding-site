<?php
	...
	else 
	{
		...
		//$req = mysql_query($sql);
		$result = $conexion->query("SELECT * FROM invitados ORDER BY idInvitados ASC");
                        	...
                        	<div class="table-responsive">
                                <table border="0" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $query_result['idInvitados']; ?></td>
                                                <td><?php echo $query_result['nombresInvitados']; ?></td>
                                                <td><?php echo $query_result['validoInvitados']; ?></td>
                                                <td><?php echo $query_result['entregadoInvitados']; ?></td>
                                                <td>CONFIRMAR</td>
                                            </tr> 
                                        <?php } ?>
                                    </tbody>
