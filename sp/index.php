        ...
        <section id="inicio">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div align="center">
                        	<img class="img-responsive" src="../images/bienvenido.png" />
                            <div id="separator" style="background:none; height:20px;"></div>
                        	<img class="img-responsive" src="../images/kelleyandjose-main-759x505.png" style="border-radius:7px; -moz-border-radius:5px;-webkit-border-radius:5px"/>
                            <div id="separator" style="background:none; height:20px;"></div> 
                            <img class="img-responsive" src="../images/kelley-and-jose.png" />
                            <img class="img-responsive" src="../images/fecha.png" />
