        ...
        <section id="inicio">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div align="center">
                        	<img class="img-responsive" src="../images/cosasquehacer.png" />
                            <div id="separator" style="background:none; height:20px;"></div>
                            <h1>Todavía estamos trabajando en esta sección, la planificación de la boda es difícil, danos un descanso.</h1>
                            <div id="separator" style="background:none; height:20px;"></div>
