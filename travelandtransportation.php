        ...
        <section id="inicio">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div align="center">
                        	<img class="img-responsive" src="images/travel-and-transportation.png" />
                            <div id="separator" style="background:none; height:20px;"></div>
                            <h1>Airports</h1>
                            <p><strong>The closest airport is Baltimore Washington International (12 miles away).</strong></p>
                            <p><strong>There is also two airports in the DC area.</strong></p>
                            <p><strong>Ronald Reagan National Airport (43 miles away) and Dulles International Airport (60 miles away).</strong></p>
                            <p><strong>From DC it is possible to take a public transportation to Baltimore.</strong></p>
                            <div id="separator" style="background:none; height:20px;"></div>
