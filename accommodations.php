        ...
        <section id="inicio">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div align="center">
                        	<img class="img-responsive" src="images/accommodations.png" />
                            <div id="separator" style="background:none; height:20px;"></div>
                            <h1>Hampton Inn and Suites Baltimore-Inner Harbor</h1>
                            <h3>131 East Redwood Street, Baltimore, Md 212023</h3>
                            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner" role="listbox">
                                <div class="item active">
                                  <img src="images/hampton inn hilton.jpg" alt="Hampton Inn & Suites Baltimore Inner Harbor">
                                </div>
                                <div class="item">
                                  <img src="images/hampton inn hilton 1.jpg" alt="Hampton Inn & Suites Baltimore Inner Harbor">
                                </div>
                                <div class="item">
                                  <img src="images/hampton-inn-suites-baltimore-inner-harbor.jpg" alt="Hampton Inn & Suites Baltimore Inner Harbor">
                                </div>
                              </div>
                            ...
                            <h3>Reservations can be made these ways:</h3>                             
                            <p><strong>1. Call our front desk at 410-539-7888 to make a reservation.</strong></p>
                            <p><strong>2. Call central reservations at 1-800-737-6950.</strong></p>
                            <p><strong>3. <a href="http://tinyurl.com/mtlbskj" target="_blank" >Our Website</a>.</strong></p>
                            <p><strong>***The Special Rate Code for your group is MRW. ***</strong></p>
                            <h3><strong>Rooms need to be reserved by December 1, 2015.</strong></h3>
                            <p><strong>The block is open from January 1-4, however you do not need to book for all those nights to receive discount. (i.e. - You can stay only the night of the 2nd).</strong></p>
							<p><strong>Special Room Rates:</strong></p>
							<p><strong>DOUBLE QUEEN - NON SMOKING rates from 109.00 USD/Night.</strong></p>
							<p><strong>1 KING BED NONSMOKING rates from 99.00 USD/Night.</strong></p>
                            <div id="separator" style="background:none; height:20px;"></div>
